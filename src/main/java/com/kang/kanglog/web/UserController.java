...
//        return new CMResDto<>(1, "좋아요 한 게시글목록", likePosts);
//    }
//
//
//
...
//
//        return new CMResDto<>(result, "회원탈퇴하였습니다.", null);
//    }
//
//
//    @LoginCheck
...
//
//        return new CMResDto<>(1, "프로필 사진을 변경하였습니다.",  userEntity.getProfileImgUrl());
//    }
//
//
//
